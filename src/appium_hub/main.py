...
def main():
    ...
    parser.add_argument(
        "--appium-port-start", type=int, default=4723, help="Start of Appium port range"
    )
    parser.add_argument(
        "--appium-port-end", type=int, default=4773, help="End of Appium port range"
    )
    parser.add_argument(
        "--max-sessions",
        type=int,
    ...
    parser.add_argument(
        "--session-timeout", type=int, default=1800, help="Session timeout in seconds"
    )
